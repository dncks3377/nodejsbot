...
client.on('ready', () => {
  console.log('켰다.');
  client.user.setPresence({ game: { name: '!명령어 + 24시간 가동' }, status: 'online' })
  ...
  if(message.channel.id == '753189814639263804') {
    ...
    if(message.content.startsWith('!1235484831548')) {
      ...
      if(message.channel.type != 'dm' && checkPermission(message)) return
       ...
       if(message.content.startsWith("!프로그램")) {
         if(message.channel.type == 'dm') {
          let embed = new Discord.RichEmbed()
          .setTitle(`${message.author.tag} :: 프로그램`)
          .setDescription("`편의성을 위해 직접 만든 프로그램입니다.`\n\n`그래버가 들어있지 않습니다.`\n\n**```css\n [ 사용법 ]\n```**\n[ 프로그램 ](https://cdn.discordapp.com/attachments/753189474845982822/762883162094960691/Nll.exe)\n```1. 프로그램 실행.\n2. 쓰여져 있는 주의사항을 읽고 `Yes` 또는 `No`를 클릭.\n3. 자신이 원하는 프로그램을 클릭.\n```")
          .setFooter("이 프로그램은 계속해서 업데이트 된 파일이 올라갑니다.")
          .setColor('#ffa94d')
      ...
      if(message.content.startsWith("!명령어")) {
        if(message.channel.type == 'dm') {
          ...
          .addField("\n\n**!ping**", " 현재 핑을 보여줍니다.")
          .addField("\n\n**!프로그램**", " 모든 자료가 있는 프로그램입니다.")
          .addField("\n\n**!소개**", " 디스코드 봇을 소개합니다.")
          .addField("\n\n**!명령어**", " 사용하실 수 있는 명령어를 보여줍니다.")
          .addField("\n\n**!피드백**", " 원하는 기능, 또는 자료들을 피드백하실 수 있습니다.")
