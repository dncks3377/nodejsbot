...
const token = 'NzU5MDAwODIyNTYxMzc0MjA4.X23ImQ.IUzqxltdmSS2RswHFVa5mrNGtb8';
...
client.on('message', (message) => {
  ...
  if(message.author.bot) return;
   ...
   if(message.content.startsWith('!2378787345248')) {
    let embed = new Discord.RichEmbed()
    .setDescription('`엣지소스, Xenos 인젝터가 들어있습니다.`\n\n`용량이 많고 X를 바이러스로 잡아서 프로그램으로 올립니다.`\n\n[클릭](https://cdn.discordapp.com/attachments/753189474845982822/761474585366495232/Uso2.exe)')
